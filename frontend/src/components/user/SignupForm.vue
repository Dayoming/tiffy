        ...
        <div class="container py-6">
            <main class="form-signin w-100 m-auto" style="text-align: center;">
                <form @submit.prevent="signupForm">
                    ...
                    <div class="form-floating mb-3">
                        <input type="password" v-model="password1" class="form-control" id="password1" placeholder="Password">
                        <label for="password1">Password</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="password" v-model="password2" class="form-control" id="password2" placeholder="Re-enter Password">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" v-model="nickname" class="form-control" id="nickname" placeholder="Nickname">
    ...
    methods: {
        async signupForm() {
            try {
                ...
                // 성공 시 메인 페이지로 리다이렉트 또는 다른 작업 수행
